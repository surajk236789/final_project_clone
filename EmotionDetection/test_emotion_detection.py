...
class TestEmotionDetector(unittest.TestCase):
    def test_emotion_detector(self):
        ...
        self.assertEqual(emotion_detector("II am really mad about this")['dominant_emotion'],'anger')
        ...
        self.assertEqual(emotion_detector(" am really afraid that this will happen")['dominant_emotion'],'fear')
